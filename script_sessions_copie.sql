...
-- Listage de la structure de table sfsessions. apprenant
...
-- Listage de la structure de table sfsessions. apprenant_session
...
-- Listage des données de la table sfsessions.apprenant_session : ~4 rows (environ)
INSERT INTO `apprenant_session` (`apprenant_id`, `session_id`) VALUES
	(1, 4),
	(2, 1),
	(2, 3),
	(3, 2);
...
-- Listage des données de la table sfsessions.categorie : ~2 rows (environ)
...
-- Listage des données de la table sfsessions.programme : ~15 rows (environ)
...
-- Listage de la structure de table sfsessions. unite
...
-- Listage des données de la table sfsessions.unite : ~9 rows (environ)
